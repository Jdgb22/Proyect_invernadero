...
_Nota:_ Las bases de datos locales (ej. SQLite en un archivo físico) quedan descartadas a menos que el Dashboard se aloje exclusivamente de manera offline en un dispositivo embebido (como una Raspberry Pi) dentro del propio invernadero.
